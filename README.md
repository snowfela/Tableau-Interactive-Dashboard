...
5. Displayed key performance indicators using Measure Names and Measure Values.
   <img width="1920" height="883" alt="Screenshot 2025-10-23 165331" src="https://github.com/user-attachments/assets/8a783423-25b3-47ef-a5ca-a8d5c73806a6" />


6. Created an interactive bar chart linked to the map view.
- First, a bar chart is created from the profit ratio, disabling the tooltip in that, and editing the colors
  <img width="1920" height="871" alt="Screenshot 2025-10-23 171115" src="https://github.com/user-attachments/assets/6ff5ef7e-8f12-4673-98cd-e9c7cc73af10" />
